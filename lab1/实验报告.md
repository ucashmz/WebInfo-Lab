...
查询 `meeting OR NOT strong AND company #`

结果返回了

```bash
Please input one space between all words(include parenthesis/brace and items), End with ' #'.
(quit by input 'EXIT')Search for:meeting OR NOT strong AND company #
Found in 119054 files. First found in farmer-d/all_documents/2167
```

排名靠前的 `farmer-d/all_documents/2167` 内容如下

```
Message-ID: <15300123.1075854017843.JavaMail.evans@thyme>
Date: Fri, 31 Mar 2000 02:36:00 -0800 (PST)
From: adrial.boals@enron.com
To: bryce.baxter@enron.com, leslie.reeves@enron.com, lisa.csikos@enron.com,
        pat.clynes@enron.com, daren.farmer@enron.com
Subject: Settlements with Barbara Epperson - Team Leadership
Cc: angela.henn@enron.com, lisa.shoemake@enron.com, yvette.connevey@enron.com,
        ragayle.pellum@enron.com
Mime-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Transfer-Encoding: 7bit
Bcc: angela.henn@enron.com, lisa.shoemake@enron.com, yvette.connevey@enron.com,
        ragayle.pellum@enron.com
X-From: Adrial Boals
X-To: Bryce Baxter, Leslie Reeves, Lisa Csikos, Pat Clynes, Daren J Farmer
X-cc: Angela Henn, Lisa Shoemake, Yvette G Connevey, Ragayle Pellum
X-bcc:
