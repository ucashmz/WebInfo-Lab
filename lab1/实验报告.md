...
(quit by input 'EXIT')Search for:today OR NOT strong AND number #
Found in 110852 files. First found in hain-m/notes_inbox/638.
```

排名靠前的 `hain-m/notes_inbox/638.` 内容如下
